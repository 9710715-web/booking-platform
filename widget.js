(()=>{
  ...
  const club=s&&s.dataset&&s.dataset.club?s.dataset.club:"istanbul-tennis-center";
  const lang=s&&s.dataset&&s.dataset.lang?s.dataset.lang:"auto";
  const currency=s&&s.dataset&&s.dataset.currency?s.dataset.currency:"auto";
  var root=document.getElementById("booking-widget");
  if(!root){root=document.createElement("div");root.id="booking-widget";root.style="position:fixed;right:16px;bottom:16px;z-index:999999";document.body.appendChild(root);}
